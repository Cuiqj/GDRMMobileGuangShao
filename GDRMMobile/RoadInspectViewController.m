...
- (void)viewDidLoad
{
    ...
    if (self.state2 == kCheckRecord) {
        [self setCurrentInspection2:nil];
    }
...
- (void)setCurrentInspection:(NSString *)inspectionID flag:(BOOL)flag{
    if (self.state2 == kCheckRecord) {
        [UIView transitionWithView:self.view
                          duration:0.3
                           options:UIViewAnimationCurveLinear
...
- (void)setCurrentInspection2:(NSString *)inspectionID{
    [UIView transitionWithView:self.view
                      duration:0.3
                       options:UIViewAnimationCurveLinear
                    animations:^{
                        ...
                        rect.size.width = 126;
                        [self.uiButtonDeliver setFrame:rect];
                        [self.uiButtonDeliver setAlpha:0.0];
                        [self.uiButtonAddNew setAlpha:0.0];
                        [self.uiButtonSave setAlpha:0.0];
                    }
                    completion:^(BOOL finish){
