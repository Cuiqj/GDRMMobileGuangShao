...
-(void)saveCitizenInfoForCase:(NSString *)caseID{
    ...
    if (![aAutoNumber isEmpty] && ![self.textParty.text isEmpty]) {
        ...
        if (caseServiceReceipt == nil) {
            caseServiceReceipt = [CaseServiceReceipt newCaseServiceReceiptForCase:self.caseID];
            [CaseServiceReceiptViewController generateDefaultInfo2:caseServiceReceipt caseID:self.caseID];
        }
