...
- (void)hasUpdateVersion{
    ...
    //蒲公英的apikey，appkey
    NSDictionary *paramDic = @{@"_api_key":@"d98734ffcbcb99a86ff217e63c46ecfe",@"appKey":@"26e13ee89e984de5b1f6d6dfc4df4b41"};
...
-(void)initServer{
    ...
    NSDictionary *temp=[settings objectForKey:@"Server Settings"];    //settings.plist里面字典
    self.serverAddress = [temp objectForKey:@"server address"];
    self.fileAddress = [temp objectForKey:@"file address"];
    self.projectDictionary = [settings objectForKey:@"Projectname"];   //setting.plist里面字典

    paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
    NSString *documentDirectory=[paths objectAtIndex:0];
    NSString *casePhotoDirectory=[documentDirectory stringByAppendingPathComponent:@"CasePhoto"];   //目录下面加图片CasePhoto
