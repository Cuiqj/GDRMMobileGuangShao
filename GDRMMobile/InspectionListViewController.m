...
{
    Inspection *inspection = [self.data objectAtIndex:indexPath.row];
    if (inspection.isuploaded.boolValue == NO) {
        [self.delegate setCurrentInspection:inspection.myid flag:YES];
    } else {
        [self.delegate setCurrentInspection:inspection.myid flag:NO];
    }
