...
@property (nonatomic,copy) NSString *recorder_name_id;
@property (nonatomic,copy) NSString *inquirer_name_id;
@end
...
-(NSURL *)toFullPDFWithPath:(NSString *)filePath{
    ...
    if (![filePath isEmpty]) {
        ...
        if ([pages count] < 2) {
            //XML测试
            // [dataInfo setObject:[@{@"inquire_name_num":inquire_name_numInfo,@"record_name_num":record_name_numInfo}mutableCopy] forKey:@"nameNumInfo"];
            dataInfo[@"nameNumInfo"][@"inquire_name_num"][@"value"]=@([self.inquirer_name_id  intValue]);
            dataInfo[@"nameNumInfo"][@"record_name_num"][@"value"]=@([self.recorder_name_id intValue]);
...
- (NSMutableDictionary *)getDataInfo{
    ...
    NSMutableDictionary *inquire_name_numInfo=[[NSMutableDictionary alloc]init];
    [inquire_name_numInfo setObject:@(NSInteger32AttributeType) forKey:@"valueType"];
    NSMutableDictionary *record_name_numInfo=[[NSMutableDictionary alloc]init];
    [record_name_numInfo setObject:@(NSInteger32AttributeType) forKey:@"valueType"];
    [dataInfo setObject:[@{@"inquire_name_num":inquire_name_numInfo,@"record_name_num":record_name_numInfo}mutableCopy] forKey:@"nameNumInfo"];
